...
public class MemberDataMapperTest
{
	...
	/**
	 * Make sure that we can add a book to a member and persist the result correctly
	 * @throws DatabaseException shouldn't
	 */
	@Test
	public void canAddBook() throws DatabaseException
	{
		...
		MemberDataMapper after = new MemberDataMapper(MembersForTest.JOSH.getMemberID());
